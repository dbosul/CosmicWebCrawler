---
name: query-vizier
description: Query VizieR catalogs for QSO candidates — default is Milliquas (VII/290)
argument-hint: <project> [--dec-min D --dec-max D] | [--ra R --dec D --radius R] [catalog] [z_min z_max]
---

Query VizieR for QSO candidates. Default catalog is Milliquas v8 (VII/290), the most
...
python src/query_vizier.py --project <project> \
    ...
    [--catalog VII/290] [--z-min 2.0] [--z-max 3.5]
...
- Default: Milliquas VII/290 — the most complete QSO compilation; use this first
